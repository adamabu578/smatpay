...
const Agents = () => {
  return (
    ...
    <div className="w-[350px] h-[350px] rounded-md bg-purple-950cd  lg:w-[1450px] lg:h-[550px] py-5 mx-5 ">
        <div className="flex flex-col  lg:mt-20 lg:flex lg:flex-row items-center">
            <img src={bill} className="w-[100px] h-[70px]  left-30  lg:w-[350px] lg:h-[350px] lg:left-40 lg:mt-20 " />
            
            <div className="mx-auto lg:mx-auto">
            <h2 className="text-black text-[18px] font-semibold mt-10  lg:mt-20 lg:text-[30px] mx-5 ">Become a Smatpay Agent</h2>
